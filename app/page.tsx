  ...
  <main className="min-h-screen bg-[#F3E9DD] text-[#0E171B]">
    ...
    <section className="relative overflow-hidden bg-[#F3E9DD] min-[1024px]:min-h-[calc(100svh-84px)]">
      ...
      <div className="relative mx-auto flex max-w-[1440px] px-5 py-14 sm:px-8 md:py-18 lg:px-10 min-[1024px]:min-h-[calc(100svh-84px)] min-[1024px]:items-center">
        <div className="mx-auto max-w-[640px] text-center min-[1024px]:mx-0 min-[1024px]:max-w-[590px] min-[1024px]:text-left">
          <p className="mb-4 text-[11px] uppercase tracking-[0.22em] text-[#8C1D40] sm:text-[12px]">
            A SUPPLEMENT SUBSCRIPTION, SIMPLIFIED
          </p>
          ...
          <p className="mx-auto mt-5 max-w-[540px] text-[17px] leading-[1.65] text-[#3E4A4E] sm:text-[18px] min-[1024px]:mx-0">
            VitaPouch is not a vitamin. It is a subscription that organizes the
            vitamins and supplements you already take — or choose to take — into
            simple packets delivered monthly.
          </p>

          <p className="mx-auto mt-4 max-w-[520px] text-[15px] leading-7 text-[#5D686C] sm:text-[16px] min-[1024px]:mx-0">
            Think a pill organizer, but simpler: each packet is ready to open
            throughout the day, so there are no bottles to manage and no routine
            to rebuild.
          </p>
          ...
          <p className="mx-auto mt-4 max-w-[480px] text-[12px] leading-5 text-[#687377] min-[1024px]:mx-0">
            Early access means we’ll notify you first when VitaPouch is ready.
          </p>

          <div className="mx-auto mt-9 grid max-w-[620px] grid-cols-2 gap-x-6 gap-y-6 sm:grid-cols-4 min-[1024px]:mx-0">
            <FeatureItem icon={<LeafIcon />} line1="NOT A" line2="VITAMIN" />
            <FeatureItem icon={<ShieldIcon />} line1="MONTHLY" line2="PACKETS" />
            <FeatureItem icon={<PersonIcon />} line1="BUILT AROUND" line2="YOUR ROUTINE" />
            <FeatureItem icon={<StarIcon />} line1="READY TO" line2="OPEN" />
          </div>
        </div>
      </div>
    </section>
      ...
      <div className="mx-auto max-w-[1080px] rounded-[34px] border border-[#DDD7CF] bg-[#F8F2EA]/90 px-6 py-9 shadow-[0_24px_70px_rgba(20,15,10,0.08)] sm:px-10 sm:py-12">
        <div className="mx-auto max-w-[760px] text-center">
          ...
          <h2
            ...
            The vitamins you take, organized into packets.
          </h2>

          <p className="mx-auto mt-4 max-w-[650px] text-[16px] leading-7 text-[#475357] sm:text-[17px]">
            Instead of opening multiple bottles throughout the day, VitaPouch
            pre-organizes your routine into easy-to-open, time-based packets —
            morning, evening, or whatever your day needs.
          </p>
        </div>
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-3">
          <ClarityCard
            title="1. Tell us what you take"
            text="Share the vitamins, supplements, quantities, and brands that matter to your routine."
          />
          <ClarityCard
            title="2. We organize it"
            text="Your routine is turned into simple daily packets designed around when you take them."
          />
          <ClarityCard
            title="3. Delivered monthly"
            text="Your packets arrive ready to open, so your routine is easier to follow every day."
          />
        </div>

        <p className="mx-auto mt-7 max-w-[720px] text-center text-[13px] leading-6 text-[#687377]">
          VitaPouch is designed to help organize supplement routines. It does
...
function ClarityCard({ title, text }: { title: string; text: string }) {
return (
  <div className="rounded-[24px] border border-[#DDD7CF] bg-[#F3E9DD]/70 p-6 text-center shadow-[0_14px_40px_rgba(20,15,10,0.04)]">
    <h3
      className="text-[22px] leading-tight tracking-[-0.025em] text-[#081620]"
      style={{ fontFamily: 'Georgia, "Times New Roman", serif' }}>
