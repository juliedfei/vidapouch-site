    ...
    <section className="bg-[#EFE2D4] px-6 py-20">
      <div className="mx-auto max-w-[1120px]">
        <div className="mx-auto max-w-[760px] text-center">
          ...
          <p className="mt-5 text-[17px] leading-8 text-[#3E4A4E]">
            If you already rely on specific supplements, Vidapouch is designed
            to learn your current routine — including the brands you prefer —
            so we can explore sourcing options that keep your routine familiar.
          </p>
        </div>
        ...
        <div className="mt-12 grid gap-5 md:grid-cols-3">
          <FeatureCard
            ...
            text="Tell us what you take today, when you take it, and which brands you already trust."
          />
          <FeatureCard
            title="Premium sourcing"
            text="We prioritize high-quality, trusted, and practitioner-grade supplement options when building routines."
          />
          <FeatureCard
            title="Trust first"
            text="Vidapouch is not about putting random pills in a pouch — it is about making a trusted routine easier to follow."
          />
        </div>
      </div>
    </section>
    ...
    <section className="px-6 pb-20 pt-20">
      <div className="mx-auto max-w-[900px] rounded-[32px] border border-[#DDD7CF] bg-[#F8F2EA]/90 px-8 py-12 text-center shadow-[0_30px_80px_rgba(20,15,10,0.08)]">
        ...
        <p className="mx-auto mt-5 max-w-[560px] text-[17px] leading-8 text-[#475357]">
          Join the waitlist and tell us what you take today — including the
          brands you already trust. Your answers help us design the first
          Vidapouch experience around real routines.
        </p>
