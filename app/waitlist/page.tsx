...
const stepContent = {
 ...
 2: {
   ...
   description:
     "Share what you currently use and when you take it, so we can understand how Vidapouch should be designed.",
 },
 3: {
     ...
     <div className="mx-auto max-w-[820px]">
       ...
       <section className="rounded-[32px] border border-[#DDD7CF] bg-[#F8F2EA]/90 px-8 py-10 shadow-[0_30px_80px_rgba(20,15,10,0.08)] md:px-12">
         ...
         <p className="mt-6 max-w-[620px] text-[18px] leading-8 text-[#475357]">
           {success
             ? "Thank you — your routine has been saved. We’ll use this to understand what people are already taking, where they buy it, and how Vidapouch should be designed."
