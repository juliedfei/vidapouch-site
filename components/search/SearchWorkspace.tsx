...
export default function SearchWorkspace({
  ...
  /*
   * Plan assignment is fully automatic.
   * The smallest plan that fits the current pouch is
   * selected after every add or removal, so customers
   * never need to choose a tier manually.
   */
  useEffect(
    () => {
      if (
