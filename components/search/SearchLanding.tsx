...
export default function SearchLanding({
 ...
 return (
   <section className="relative overflow-hidden bg-[#F3E9DD]">
     <img
       src="/images/home-v2/hero/hero.PNG"
       alt=""
       aria-hidden="true"
       className="
         absolute
     ...
     <div
       ...
       <div className="w-full max-w-[720px]">
         ...
         <p
           ...
           Find the highest quality supplements, compare trusted brands, and
           choose how you want to get them.
         </p>

         <div className="mt-6 w-full max-w-[590px]">
           <SearchBar
             value={query}
             onChange={setQuery}
             variant="hero"
         ...
         <div className="mt-7">
           <div className="flex flex-wrap items-center gap-x-2 gap-y-2">
             <span className="mr-1 text-[11px] font-semibold text-[#263235]">
               Popular searches:
             </span>
         ...
         <div className="mt-4">
           <p className="mb-2 text-[11px] font-semibold text-[#263235]">
             Browse health goals:
           </p>
           ...
           <div
             ...
             {wellnessGoals.map(({ label, icon: Icon }) => (
               <button
                 key={label}
                 type="button"
