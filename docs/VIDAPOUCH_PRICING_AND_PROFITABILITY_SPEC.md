...
|---|---:|---:|
| Essential | $39.99 | Up to 3 |
| Complete | $59.99 | Up to 5 |
| Premier | $79.99 | Up to 8 |
...
values
  ('essential', 'Essential', 39.99, 3, null, 'single-box', 1),
  ('complete', 'Complete', 59.99, 5, null, 'dual-box', 2),
  ('premier', 'Premier', 79.99, 8, null, 'dual-box', 3);
```
